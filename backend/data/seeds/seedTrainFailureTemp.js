...
function seedTrainFailureTemplate(adminUser) {
  console.log("🌱 Seeding incident plan train failure...");
  ...
  console.log("✅ Incident plan train failure seeded");
}

module.exports = seedTrainFailureTemplate;
